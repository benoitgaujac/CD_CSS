...
def mix_q(x,num_samples,srng):
    samples_u, logq_u, _ = uniform(x, num_samples/4, srng)
    samples_bu, logq_bu, _ = blobs_uniform(x, num_samples/4, srng)
    samples_s1, logq_s1, _ = stupidq(x, num_samples/4, 0.1, srng)
    samples_s2, logq_s2, _ = stupidq(x, num_samples/4, 0.4, srng)
